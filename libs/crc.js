...
}(this, function()
{
    ...
    function crc32Add(crc,c){
        ...
        // CRC32_TAB [(crc^c) & 0xFF] ^ ((crc>>8) & 0xFFFFFF)
        var para1 = andOper32( xorOper32(crc.toString(2), c.toString(2)).toString(2), (su1).toString(2));
        var para2 = andOper32((crc>>>8).toString(2), (su2).toString(2));
        return xorOper32(CRC32_TAB[para1].toString(2), para2.toString(2));
        //console.log('returnVal :%s',returnVal);
    }

    function xorOper32(op1, op2){
        var op1Len = op1.length;
        var op2Len = op2.length;
        ...
        var result = "";
        for(var i= 0; i<32; i++){
            if(parseInt(op1[i]) === parseInt(op2[i])){
                result += '0';
            } else{
                result += '1';
            }
    ...
    function crc32Buffer(buf)
    {
        ...
        var su = 0xFFFFFFFF;
        return xorOper32(crc.toString(2), su.toString(2));
    }
